...
#ifndef HEADER_FOR_KABUKI_TOOLKIT_HMI_MODEBUTTON
#define HEADER_FOR_KABUKI_TOOLKIT_HMI_MODEBUTTON

#include "button.h"

namespace kt { namespace hmi { namespace Buttons {
...
/** A ModeButton is a ButtonMacro that has the ability to change the Device on a ControlSurfaces.
...
#endif  //< HEADER_FOR_KABUKI_TOOLKIT_HMI_MODEBUTTON
