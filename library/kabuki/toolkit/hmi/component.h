...
#ifndef HEADER_FOR_KABUKI_TOOLKIT_HMI_HMICOMPONENT
#define HEADER_FOR_KABUKI_TOOLKIT_HMI_HMICOMPONENT
...
class KABUKI HmiComponent {
    ...
    /** Compares this label to the given string.
        @return Returns 0 if they are identical and1 if the other char* is too uint32_t. */
    int Compare (const char* s) const;
         
    /** Prints this object to a string. */
    virtual _::Printer& Print (_::Printer& print) const;
...
#endif  //< HEADER_FOR_KABUKI_TOOLKIT_HMI_HMICOMPONENT
