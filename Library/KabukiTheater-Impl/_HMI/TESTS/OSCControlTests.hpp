/** Kabuki Theater
    @file    /.../KabukiTheater-Library/KabukiTheater-Impl/_HMI/TESTS/OSCControlTests.hpp
...
#include <_HMI/OSCControl.hpp>

#if DEBUG

class OSCControlTests : public UnitTest
/** Unit test for the OSCControl class _KabukiTheater. */
{
    public:
    ...
    void runTest () 
    {
        ...
        LogMessage ("Done testing OSCControl class _KabukiTheater");
    }
