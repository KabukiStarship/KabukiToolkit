...
/*< Gives access to the real-time state of the touches
    ...
    _HMI::Vect2D<int> globalPos = _HMI::Touch::getPosition(1);
   
    // get position of touch 1 relative to a window
    _HMI::Vect2D<int> relativePos = _HMI::Touch::getPosition(1, window);
    @endcode
    ...
    @see _HMI::Joystick, _HMI::Keyboard, _HMI::Mouse */
{
    ...
    static Vect2D<int> getPosition(uint finger);
    ...
    static Vect2D<int> getPosition(uint finger, const Window& relativeTo);
