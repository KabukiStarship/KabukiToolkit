...
source code root. This files gets #include <AssemblySettings.inl> in the config
file. That means that the compiler will look in your source code root before
looking in this file. Please see config.h for configuration details. */
...
#define USE_MORE_ROM YES   //< Inline functions or makes them static.
