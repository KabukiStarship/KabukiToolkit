...
template<typename T>
class _KabukiTheater_ Parameter: public HMIComponent
/** A parameter with upper and lower bounds and IO channel.
...
*/
{
    ...
    virtual int compare (const Parameter& o) const;
    ...
    int channel;        //< The output channel.
