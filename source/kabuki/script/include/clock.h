...
KABUKI bool PrintTimeStruct (tm* std_tm);
...
KABUKI bool PrintTimeStructString (char* buffer, int buffer_size, tm* std_tm);
...
*/
KABUKI const char* ParseTimeStructString (const char* input, tm* std_tm);
...
KABUKI void ZeroTime (tm* std_tm);
