...
class _KabukiTheater_ Touch
/*< Gives access to the real-time state of the touches
    @ingroup _Theater/HMI
   
    _Theater/HMI::Touch provides an interface to the state of the
    ...
    and TouchEnded events, _Theater/HMI::Touch can retrieve the
    ...
    Usage example:
    @code
    if (_Theater/HMI::Touch::isDown(0))
    {
        // touch 0 is down
    }
   
    // get global position of touch 1
    _Theater/HMI::Vector2i globalPos = _Theater/HMI::Touch::getPosition(1);
   
    // get position of touch 1 relative to a window
    _Theater/HMI::Vector2i relativePos = _Theater/HMI::Touch::getPosition(1, window);
    @endcode
   
    @see _Theater/HMI::Joystick, _Theater/HMI::Keyboard, _Theater/HMI::Mouse */
{
    public:
