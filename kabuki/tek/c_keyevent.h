...
@file    /kabuki/tek/t_t_key_event.h
...
class EventVKCode {
 public:
  ...
  EventVKCode (UI1 vk_code)
    : vk_code_ (vk_code);

  /* Gets the VK code of the event. */
  UI1 GetVKCode () { return vk_code_; }
 ...
 private:
  ...
  UI1 vk_code_;  //< VK keyboard code of the event.
};
