...
#ifndef KABUKI_THEATER_HMI_KEYBOARD_H
#define KABUKI_THEATER_HMI_KEYBOARD_H
...
/** Give access to the real-time state of the keyboard. 
    ...
    _hmi::Keyboard provides an interface to the state of the
    ...
    _hmi::Keyboard can retrieve the state of a key at any time
    ...
    Usage example:
    @code
    if (_hmi::Keyboard::isKeyPressed(_hmi::Keyboard::Left)) {
        // move left...
    } else if (_hmi::Keyboard::isKeyPressed(_hmi::Keyboard::Right)) {
        // move right...
    } else if (_hmi::Keyboard::isKeyPressed(_hmi::Keyboard::Escape)) {
        // quit...
    }
    @endcode
   
    @see _hmi::Joystick, _hmi::Mouse, _hmi::Touch */
class HMI_API Keyboard {
    public:
...
#endif  //< KABUKI_THEATER_HMI_KEYBOARD_H
