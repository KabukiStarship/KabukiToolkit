...
#ifndef HEADER_FOR_KABUKI_TOOLKIT_HMI_WIDGETPAGE
#define HEADER_FOR_KABUKI_TOOLKIT_HMI_WIDGETPAGE
...
class KABUKI WidgetPage {
    ...
    data::Array<MidiControl*>   knobs_;         //< Knob controls.
    data::Array<Button*>        bttns_;         //< Button controls.
    data::Array<ControlMatrix*> control_group_; //< Array of pointers to ControlMatrix objects.
};

}       //< namespace hmi
}       //< namespace toolkit
}       //< namespace kabuki
#endif  //< HEADER_FOR_KABUKI_TOOLKIT_HMI_WIDGETPAGE
