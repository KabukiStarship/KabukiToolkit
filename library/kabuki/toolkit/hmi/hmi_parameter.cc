...
Parameter::Parameter (uint16_t type, const char* label, uint16_t channel, uint16_t init_value, uint16_t min_value, uint16_t max_value,
                      uint16_t word_size) :
    Parameter (label) {
    setType (type);
...
uint16_t Parameter::GetType () const {
    return type_;
}
...
uint16_t Parameter::GetChannel () const {
    return channel;
}

uint16_t Parameter::GetNumChannels () const {
    return num_channels_;
}

uint16_t Parameter::GetValue () const {
    return value_;
}

uint16_t Parameter::GetLSBValue () const {
    return value_ & 0xff;
}

uint16_t Parameter::GetMsbValue () const {
    return (value_ & 0xff00) >> 8;
}

uint16_t Parameter::GetInitValue () const {
    return init_value_;
}

uint16_t Parameter::GetMinValue () const {
    return min_value_;
}

uint16_t Parameter::GetMaxValue () const {
    return max_value_;
}

uint16_t Parameter::GetWordSize () const {
    return word_size_;
}

uint16_t Parameter::GetMinWordSize () const {
    return min_word_size_;
}

uint16_t Parameter::GetMaxWordSize () const {
    return max_word_size;
}

uint16_t Parameter::GetMinWordValue () const {
    return min_word_value;
}

uint16_t Parameter::GetMaxWordValue () const {
    return maxWordValue;
}
