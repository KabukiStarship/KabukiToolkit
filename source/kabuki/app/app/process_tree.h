/** Kabuki Starship
    @file    ~/Source/kabuki/theater/app/process_tree.h
...
class KTH_APP_API WindowGroup
{
    ...
    WindowGroup (Window& this_window);

    /** Constructor initializes with an array of windows. */
    WindowGroup (vector<Window> init_windows);
    ...
    long uid_;                  //< The UID of this Group.
