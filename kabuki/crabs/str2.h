/* Kabuki Toolkit
@version 0.x
@file    $kabuki-toolkit/kabuki/crabs/str2.h
...
KABUKI const char16_t* TextNumberStop(const char16_t* begin);
...
KABUKI const char16_t* Scan(const char16_t* begin, int8_t& result);
...
@return Returns a pointer to the next char16_t after the end
of the read number or nil upon failure. */
KABUKI const char16_t* Scan(const char16_t* text, int8_t& result);
...
@return Returns a pointer to the next char16_t after the end
of the read number or nil upon failure. */
KABUKI const char16_t* Scan(const char16_t* text, uint8_t& result);
...
@return Returns a pointer to the next char16_t after the end
of the read number or nil upon failure. */
KABUKI const char16_t* Scan(const char16_t* text, int16_t& result);
...
@return Returns a pointer to the next char16_t after the end
of the read number or nil upon failure. */
KABUKI const char16_t* Scan(const char16_t* text, uint16_t& result);
...
@return Returns a pointer to the next char16_t after the end
of the read number or nil upon failure. */
KABUKI const char16_t* Scan(const char16_t* text, int32_t& result);
...
@return Returns a pointer to the next char16_t after the end
of the read number or nil upon failure. */
KABUKI const char16_t* Scan(const char16_t* text, uint32_t& result);
...
@return Returns a pointer to the next char16_t after the end
of the read number or nil upon failure. */
KABUKI const char16_t* Scan(const char16_t* text, int64_t& result);
...
@return Returns a pointer to the next char16_t after the end
of the read number or nil upon failure. */
KABUKI const char16_t* Scan(const char16_t* text, uint64_t& result);
...
@return Returns a pointer to the next char16_t after the end
of the read number or nil upon failure. */
KABUKI const char16_t* Scan(const char16_t* text, float& result);
...
@return Returns a pointer to the next char16_t after the end
of the read number or nil upon failure. */
KABUKI const char16_t* Scan(const char16_t* text, double& result);
