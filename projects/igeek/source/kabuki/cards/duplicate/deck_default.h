...
#include "../Library/KabukiCardGames/Card.h"
...
public:
    ...
    Card (uint thisValue, Suit thisSuit, Culture thisCulture=french);       //< Constructor.
    virtual ~Card () {}                                                     //< Virtual destructor so users can make a Card sub-class!

    int compare(const Card& other);                                         //< Compares this Card to the other Card and returns 0 if they are identical.
    bool equals(const Card& other);                                         //< Compares this Card to the other Card and returns true if the two are identical.

    uint getValue ();                                                       //< Returns the face value of this Card.
    Suit getSuit ();                                                        //< Returns the Suit of this card.

    Culture getCulture ();                                                  //< Returns the Culture of this Card.
    void setCulture (Culture newCulture);                                   //< Function sets the culture to the newCulture.

    String getSuitString ();                                                //< Returns a String representation of the suit.
