...
//#define NANOGUI_SHOW_WIDGET_BOUNDS 1
     ...
     *
     * The macro `namespace _ {` will expand to `namespace
     ...
     * `} //< namespace _` will expand to only `}`.
     *
     * @param name
...
#    define SDK __attribute__ ((visibility("default")))
#  else
#    define SDK
#  endif
#else
...
// Type alias to allow `Eigen::Vector2f` to be used as `_::Vector2f`.
using Vector2f = Eigen::Vector2f;
// Type alias to allow `Eigen::Vector3f` to be used as `_::Vector3f`.
using Vector3f = Eigen::Vector3f;
// Type alias to allow `Eigen::Vector4f` to be used as `_::Vector4f`.
using Vector4f = Eigen::Vector4f;
// Type alias to allow `Eigen::Vector2i` to be used as `_::Vector2i`.
using Vector2i = Eigen::Vector2i;
// Type alias to allow `Eigen::Vector3i` to be used as `_::Vector3i`.
using Vector3i = Eigen::Vector3i;
// Type alias to allow `Eigen::Vector4i` to be used as `_::Vector4i`.
using Vector4i = Eigen::Vector4i;
// Type alias to allow `Eigen::Matrix3f` to be used as `_::Matrix3f`.
using Matrix3f = Eigen::Matrix3f;
// Type alias to allow `Eigen::Matrix4f` to be used as `_::Matrix4f`.
using Matrix4f = Eigen::Matrix4f;
// Type alias to allow `Eigen::VectorXf` to be used as `_::VectorXf`.
using VectorXf = Eigen::VectorXf;
// Type alias to allow `Eigen::MatrixXf` to be used as `_::MatrixXf`.
...
public:
    ...
    Color contrastingColor() const {
        ...
        return {luminance < 0.5f ? 1.f : 0.f, 1.f};
    }
 ...
 */
extern SDK std::vector<std::string>
file_dialog(const std::vector<std::pair<std::string, std::string>> &filetypes,
 ...
 */
extern SDK void chdir_to_bundle_parent();
#endif
...
#define nvgImageIcon(ctx, name) _::__nanogui_get_image(ctx, #name, name##_png, name##_png_size)

// Helper function used by nvgImageIcon
extern SDK int __nanogui_get_image(NVGcontext *ctx, const std::string &name, uint8_t *data, uint32_t size);
