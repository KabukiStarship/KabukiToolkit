/** Kabuki Toolkit
    @file    ~/source/hmi/device_button.h
...
#ifndef HEADER_FOR_KABUKI_TOOLKIT_HMI_DEVICEBUTTON
#define HEADER_FOR_KABUKI_TOOLKIT_HMI_DEVICEBUTTON
...
#endif  //< HEADER_FOR_KABUKI_TOOLKIT_HMI_DEVICEBUTTON
