...
class ChineseRoomProject : public Project
{
    public:
...
class KabukiTheaterProject: public Project
{
    public:
    
    KabukiTheaterProject () :
...
static void RunTests (Project& root, ProjectNode* stack)
{
    ...
    //root.AddProject (new ChineseRoomProject ());
    //root.AddProject (new KabukiTheaterProject ());
