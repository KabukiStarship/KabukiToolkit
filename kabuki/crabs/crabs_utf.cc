...
char* TextClone(const char* text) { return TextClone<char>(text); }
...
const char* TextNumberEnd(const char* text, const char* text_end) {
  return TextNumberEnd<char>(text, text_end);
}
...
char* PrintCenter(char* begin, char* end, char character, int column_count) {
  return PrintCenter<char>(begin, end, Utf8Text(character).GetString(),
                           column_count);
}

char* PrintCenter(char* begin, char* end, int32_t value, int column_count) {
  return PrintRight<char>(begin, end, Utf8Text(value).GetString(),
                          column_count);
}
...
char* PrintRight(char* begin, char* end, char character, int column_count) {
  return PrintRight<char>(begin, end, Utf8Text(character).GetString(),
                          column_count);
}
...
const char* TextScan(const char* string, int8_t& result) {
  return TextScanSigned<char, int8_t>(string, result);
}

const char* TextScan(const char* string, uint8_t& result) {
  return TextScanUnsigned<char, uint8_t>(string, result);
}

const char* TextScan(const char* string, int16_t& result) {
  return TextScanSigned<char, int16_t>(string, result);
}

const char* TextScan(const char* string, uint16_t& result) {
  return TextScanUnsigned<char, uint16_t>(string, result);
}

const char* TextScan(const char* string, int32_t& result) {
  return TextScanSigned<char, int32_t>(string, result);
}

const char* TextScan(const char* string, uint32_t& result) {
  return TextScanUnsigned<char, uint32_t>(string, result);
}

const char* TextScan(const char* string, int64_t& result) {
  return TextScanSigned<char, int64_t>(string, result);
}

const char* TextScan(const char* string, uint64_t& result) {
...
const char* Utf8Text::GetString() { return string; }
...
const char* Utf8Center::GetString() {
...
const char* Utf8Right::GetString() {
  return (string == nullptr) ? number.GetString() : string;
}
...
_::Utf8& operator<<(_::Utf8& utf, _::Utf8Center item) {
  return utf.Set(_::PrintCenter(utf.begin, utf.end, item.GetString(),
                                item.GetColumnCount()));
}

_::Utf8& operator<<(_::Utf8& utf, _::Utf8Right item) {
  return utf.Set(_::PrintRight(utf.begin, utf.end, item.GetString(),
                               item.GetColumnCount()));
}
...
const char16_t* TextNumberEnd(const char16_t* text, const char16_t* text_end) {
  return TextNumberEnd<char16_t>(text, text_end);
}
