/** Kabuki Toolkit
    @file    ~/source/hmi//IsymmetricController.h
...
#ifndef HEADER_FOR_KABUKI_TOOLKIT_HMI_ISYMMETRICCONTROLLER
#define HEADER_FOR_KABUKI_TOOLKIT_HMI_ISYMMETRICCONTROLLER
...
class IsymmetricController: public Controller {
    ...
    */
    ...
    data::Array<Widget*> modes,    //< 5 different modes on the Symmetry Live!
    ...
    //data::Array<MIDIDevice> devices; //< array of all of the MIDI devices currently attached to this system.
...
#endif  //< HEADER_FOR_KABUKI_TOOLKIT_HMI_ISYMMETRICCONTROLLER
