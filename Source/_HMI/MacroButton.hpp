/** Kabuki Theater
    @file    /.../Source/_HMI/MacroButton.hpp
...
*/
class _KabukiTheater_ MacroButton : public Parameter<int>, public IButton
{
    public:
    ...
    std::vector<Parameter<int>*> controls;  //< A vector of AV control points.

    void clearList (std::vector<Parameter<int>*>* thisNode);
    //< Recursivly deletes all of the nodes.

    Parameter<int>* removeAfter (std::vector<Parameter<int>*>* thisNode);
