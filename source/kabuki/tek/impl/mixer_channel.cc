/** Kabuki Tek
    @file    /.../Source/KabukiTek-Impl/MixerChannel/MixerChannel.cpp
...
const char* MixerChannel::Op (byte index, Uniprinter* io)
{
    switch (Index)
    {
    ...
    return Query ? Enquery ("MixerChannel", "tek::Mixer"): InvalidIndex ();
}
