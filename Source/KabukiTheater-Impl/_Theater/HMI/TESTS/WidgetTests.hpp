/** Kabuki Theater
    @file    /.../Source-Library/KabukiTheater-Impl/_HMI/TESTS/WidgetTests.hpp
...
class WidgetUnitTest : public UnitTest
{
    ...
    void runTest ()
    {
        beginTest ("Testing Controls::Widget class _KabukiTheater_\n" + ConsoleLine ('~'));
        ...
        logMessage ("Done testing Widget class _KabukiTheater_");
    }
};