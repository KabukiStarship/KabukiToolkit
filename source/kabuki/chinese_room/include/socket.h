/** The Chinese Room
    @version 0.x
    @file    ~/source/kabuki/chinese_room/include/socket.h
...
#ifndef CHINESE_ROOM_SOCKET_H
#define CHINESE_ROOM_SOCKET_H
...
/** Gets a pointer to the array of pointers to Slot(s). */
KABUKI Slot** SocketSlots (Socket* s);
...
KABUKI void SocketPrint (Socket* s);

}       //< namespace _
#endif  //< CHINESE_ROOM_SOCKET_H
