...
@file    kabuki-toolkit.git/seams/0_0_seam_tests/assembly.h
...
// Macro defines the CPU endian; set to IS_STUPID for little endian CPUS and
...
#define CRABS_STRING_SIZE 4  //< Set to 1, 2, or 4 (bytes) only, usually 4.
...
// CRABS_ASSERT_PAUSE then that macro is overridden
#define CRABS_ASSERT_FREEZE YES

// Debug flag instructs the behavior of the ASSERT macro to pause; if
// CRABS_ASSERT_FREEZE is YES then this macro is overridden.
