/** CS 162 Program 4-5
    ...
    @brief  File contains the implementation of the Task class.
*/
...
{
    PrintBreak ();
    printf      ("| Task (%3f): %s", weight_, summary_);
    PrintBreak ("\n|", '-');
    std::cout << "| Begins: ";
...
const char* Task::Command (char* input)
{
    ...
    time_t t;       //< Time to (possibly) be parsed.
