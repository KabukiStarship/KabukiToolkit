...
/**
 * The <code>PathIterator_f</code> interface provides the mechanism
...
class IPathIterator_f
{
     ...
     * Each point is stored as a (x, y) float coordinates.
     ...
     * @see #SEG_CLOSE
     */
    virtual int currentSegment(float* coords) = 0;
     ...
     * @see #SEG_CLOSE
     */
    virtual int currentSegment(double* coords) = 0;
};
