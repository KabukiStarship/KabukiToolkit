...
class Project;
using ProjectArray  = _::Array<Schedule*>;
using ScheduleArray = _::Array<Project*>;
...
const char* Push (_::Array<Project*>* stack, Project* project);
...
class Project
{
    ...
    */
    ...
    const char* Command (char* input, _::Array<Project*>* stack);
