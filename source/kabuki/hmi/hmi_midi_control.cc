/** Kabuki Toolkit
    @file    ~/source/kabuki/hmi/midi_control.cc_
...
:   Parameter<int> (type, label, channel, init_value, min_value, max_value, word_size)
{
    SetCC (cc);
}
...
/** Returns cc_ text representation of this Control in cc_ row format without headers. */
