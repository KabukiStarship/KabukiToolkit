/** Kabuki Toolkit
    @file    ~/source/kabuki/hmi/hmi_component.h
...
#ifndef HEADER_FOR_KABUKI_HMI_HMICOMPONENT
#define HEADER_FOR_KABUKI_HMI_HMICOMPONENT
...
#endif  //< HEADER_FOR_KABUKI_HMI_HMICOMPONENT
