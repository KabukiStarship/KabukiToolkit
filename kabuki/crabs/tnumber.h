...
#ifndef HEADER_FOR_CRABS_TNUMBER
#define HEADER_FOR_CRABS_TNUMBER
#include "config.h"
...
are in 2's compliment. To convert from 2's comliment to unsigned you must
...
#endif  //< #if HEADER_FOR_CRABS_TNUMBER
