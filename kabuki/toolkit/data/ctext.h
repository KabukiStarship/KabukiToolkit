...
#ifndef INCLUDED_SCRIPT_TEXT
#define INCLUDED_SCRIPT_TEXT
...
template <typename Char, size_t kSize_ = kTextSize>
class TString: public TTStrand, public Operand {
    public:
    ...
    CH1 buffer_[kSize]; //< Statically allocated Strand buffer.
};      //< class Text
}       //< namespace _
#endif  //< USING_SCRIPT_TEXT
#endif  //< INCLUDED_SCRIPT_TEXT
#endif
