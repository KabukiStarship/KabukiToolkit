/** Kabuki Toolkit
    @file    ~/source/kabuki/hmi/mode_button.cc
...
const Operation* ModeButton::op (_::Terminal* io, int index)
{
    switch (index)
    {
    ...
    return Query ? Enquery ("ModeButton", "kabuki::HMI::Buttons"): InvalidIndex ();
}
