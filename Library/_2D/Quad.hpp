...
/*< A 2D quadralateral storted as float types. */
{
    ...
    Quad_f (float initX0, float initY0, float initX1, float initY1, float initX2, float initY2, float initX3, 
        float initY3);
    /*< Default constructor initializes with given Point. */

    inline void set (float newX0, float newY0, float newX1, float newY1, float newX2, float newY2, float newX3, 
        float newY3);
...
/*< A 2D quadralateral. */
{
    ...
    Quad_d (double initX1, double initY1, double initX2, double initY2, 
        double initX3, double initY3, double initX4, double initY4);
    /*< Default constructor initializes with given Point. 
    ...
    */
    ...
    inline void translate (const Vect_d& v);
    /** translates the given vector to the point.
