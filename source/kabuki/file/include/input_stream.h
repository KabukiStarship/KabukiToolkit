...
#include <ChineseRoom\Config.h>

namespace _ {
    
class _ChineseRoom_ InputStream
/*< Abstract class for custom file input streams.
    @ingroup system
   
    This class allows users to define their own file input sources from which 
    SFML can load resources.
   
    SFML resource classes like _::Texture and _::SoundBuffer provide 
    loadFromFile and loadFromMemory functions, which read data from 
    conventional sources. However, if you have data coming from a different 
    source(over a network, embedded, encrypted, compressed, etc) you can 
    derive your own class from _::InputStream and load SFML resources with 
