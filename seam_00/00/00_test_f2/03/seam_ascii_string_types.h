...
@file    ~/seam_00/00/01_test_crabs/01/00/seam.h
...
const char* Seam_00_00_00__03(char* seam_log, char* seam_end,
                              const char* args) {
  Printf("\n    Testing SEAM_00_01_00... ");
  ...
  Compare(0, result) print << expr << Dump();
  ...
  Compare(0, BOutWrite(
                 bout, Params<2, STR, 6, STR, 6>(),
                 Args(args, expected_string1, expected_string2))) void** test =
  ...
  Compare(
      ...
      Compare(0, BOutRead(bout,
                          Params<11, SVI, SVI, SVI, SVI, SVI, SVI, SVI, SVI,
                                 SVI, SVI, SVI>(),
                          Args(args, &svi_found[0], &svi_found[1],
                               &svi_found[2], &svi_found[3], &svi_found[4],
                               &svi_found[5], &svi_found[6], &svi_found[7],
                               &svi_found[8], &svi_found[9], &svi_found[10])))
          Compare(svi_expected[0], svi_found[0])
              Compare(svi_expected[1], svi_found[1]) Compare(
                  svi_expected[2], svi_found[2]) Compare(svi_expected[3],
                                                         svi_found[3])
                  Compare(svi_expected[4], svi_found[4]) Compare(
                      svi_expected[5], svi_found[5]) Compare(svi_expected[6],
                                                             svi_found[6])
                      Compare(svi_expected[7], svi_found[7]) Compare(
                          svi_expected[8], svi_found[8])
                          Compare(svi_expected[9], svi_found[9]) Compare(
                              svi_expected[10], svi_found[10])
  ...
  Compare(0, BOutWrite(bout, Params<4, SI2, SI2, UI2, HLF>(),
      ...
      Compare(0, BOutRead(bout, Params<4, SI2, SI2, UI2, HLF>(),
                          Args(args, &si2_p_found, &si2_n_found, &ui2_found,
                               &hlf_found)))
          Compare(si2_p_expected, si2_p_found) Compare(
              si2_n_expected, si2_n_found) Compare(ui2_expected, ui2_found)
  ...
  Compare(0, BOutWrite(bout, Params<5, TME, SI8, SI8, UI8, DBL>(),
      ...
      Compare(0, BOutRead(bout, Params<5, TME, SI8, SI8, UI8, DBL>(),
          ...
          Compare(tmu_expected, tmu_found) Compare(si8_p_expected, si8_p_found)
  ...
  int16_t svi_found[7];
  Compare(0,
          BOutWrite(bout, Params<7, SVI, SVI, SVI, SVI, SVI, SVI, SVI>(),
                  ...
                  Compare(svi_expected[2], svi_found[2])
                      Compare(svi_expected[3], svi_found[3])
                          Compare(svi_expected[4], svi_found[4])
                              Compare(svi_expected[5], svi_found[5]) Compare(
                                  svi_expected[6], svi_found[6])

                                  PRINT_HEADING("Testing UVI...")

                                      static const uint16_t uv2_expected[] = {
                                          0, 1, 1 << 7, 1 << 14};
  ...
  Compare(
      ...
      Compare(0, BOutRead(bout,
                          ...
                          Args(args, &sv4_found[0], &sv4_found[1],
                               &sv4_found[2], &sv4_found[3], &sv4_found[4],
                               &sv4_found[5], &sv4_found[6], &sv4_found[7],
                               &sv4_found[8], &sv4_found[9], &sv4_found[10])))
          Compare(sv4_expected[0], sv4_found[0])
              Compare(sv4_expected[1], sv4_found[1]) Compare(
                  sv4_expected[2], sv4_found[2]) Compare(sv4_expected[3],
                                                         sv4_found[3])
                  Compare(sv4_expected[4], sv4_found[4]) Compare(
                      sv4_expected[5], sv4_found[5]) Compare(sv4_expected[6],
                                                             sv4_found[6])
                      Compare(sv4_expected[7], sv4_found[7]) Compare(
                          sv4_expected[8], sv4_found[8])
                          Compare(sv4_expected[9], sv4_found[9]) Compare(
                              sv4_expected[10], sv4_found[10])
  ...
  Compare(
      ...
      Compare(
          ...
          BOutRead(bout,
                   Params<19, SV8, SV8, SV8, SV8, SV8, SV8, SV8, SV8, SV8, SV8,
                          SV8, SV8, SV8, SV8, SV8, SV8, SV8, SV8, SV8>(),
                   Args(args, &sv8_found[0], &sv8_found[1], &sv8_found[2],
                        &sv8_found[3], &sv8_found[4], &sv8_found[5],
                        &sv8_found[6], &sv8_found[7], &sv8_found[8],
                        &sv8_found[9], &sv8_found[10], &sv8_found[11],
                        &sv8_found[12], &sv8_found[13], &sv8_found[14],
                        &sv8_found[15], &sv8_found[16], &sv8_found[17],
                        &sv8_found[18]))) Compare(sv8_expected[0], sv8_found[0])
          Compare(sv8_expected[1], sv8_found[1]) Compare(
              sv8_expected[2], sv8_found[2]) Compare(sv8_expected[3],
                                                     sv8_found[3])
              Compare(sv8_expected[4], sv8_found[4]) Compare(
                  sv8_expected[5], sv8_found[5]) Compare(sv8_expected[6],
                                                         sv8_found[6])
                  Compare(sv8_expected[7], sv8_found[7]) Compare(
                      sv8_expected[8], sv8_found[8]) Compare(sv8_expected[9],
                                                             sv8_found[9])
                      Compare(sv8_expected[10], sv8_found[10]) Compare(
                          sv8_expected[11],
                          sv8_found[11]) Compare(sv8_expected[12],
                                                 sv8_found[12])
                          Compare(sv8_expected[13], sv8_found[13]) Compare(
                              sv8_expected[14],
                              sv8_found[14]) Compare(sv8_expected[15],
                                                     sv8_found[15])
                              Compare(sv8_expected[16], sv8_found[16]) Compare(
                                  sv8_expected[17],
                                  sv8_found[17]) Compare(sv8_expected[18],
                                                         sv8_found[18])
  ...
  Compare(0, BOutWrite(
                 ...
                 Args(args, &uv8_expected[0], &uv8_expected[1],
                      &uv8_expected[2], &uv8_expected[3], &uv8_expected[4],
                      &uv8_expected[5], &uv8_expected[6], &uv8_expected[7],
                      &uv8_expected[8], &uv8_expected[9], &uv8_expected[10],
                      &uv8_expected[11], &uv8_expected[12], &uv8_expected[13])))
      Compare(
          0,
          BOutRead(
              bout,
                  ...
                  Compare(uv8_expected[2], uv8_found[2])
                      Compare(uv8_expected[3], uv8_found[3])
                          Compare(uv8_expected[4], uv8_found[4])
                              Compare(uv8_expected[5], uv8_found[5]) Compare(
                                  uv8_expected[6], uv8_found[6])
