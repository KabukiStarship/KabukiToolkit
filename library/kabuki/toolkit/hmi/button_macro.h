...
#ifndef HEADER_FOR_KABUKI_TOOLKIT_HMI_MACRO_BUTTON
#define HEADER_FOR_KABUKI_TOOLKIT_HMI_MACRO_BUTTON
...
class KABUKI ButtonMacro : public Parameter<int>, public Button {
    ...
    int Add (data::Array<Parameter<int>*>& newEvents);
    ...
    data::Array<Parameter<int>*> controls;  //< A vector of Parameter<int> points.
};
...
#endif  //< #ifndef HEADER_FOR_KABUKI_TOOLKIT_HMI_MACRO_BUTTON
