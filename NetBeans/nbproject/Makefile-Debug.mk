...
${OBJECTDIR}/_ext/f3c4c907/BookTests.o: ../Source/KabukiTheater/_/TESTS/BookTests.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f3c4c907/BookTests.o ../Source/KabukiTheater/_/TESTS/BookTests.cpp

${OBJECTDIR}/_ext/f3c4c907/DaemonTests.o: ../Source/KabukiTheater/_/TESTS/DaemonTests.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/f3c4c907
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f3c4c907/DaemonTests.o ../Source/KabukiTheater/_/TESTS/DaemonTests.cpp

${OBJECTDIR}/_ext/f3c4c907/RecordTableTests.o: ../Source/KabukiTheater/_/TESTS/RecordTableTests.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/f3c4c907
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f3c4c907/RecordTableTests.o ../Source/KabukiTheater/_/TESTS/RecordTableTests.cpp

${OBJECTDIR}/_ext/f3c4c907/TerminalAndMirrorTests.o: ../Source/KabukiTheater/_/TESTS/TerminalAndMirrorTests.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/f3c4c907
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f3c4c907/TerminalAndMirrorTests.o ../Source/KabukiTheater/_/TESTS/TerminalAndMirrorTests.cpp

${OBJECTDIR}/_ext/f3c4c907/UtilsTests.o: ../Source/KabukiTheater/_/TESTS/UtilsTests.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/f3c4c907
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f3c4c907/UtilsTests.o ../Source/KabukiTheater/_/TESTS/UtilsTests.cpp

${OBJECTDIR}/_ext/f3c4c907/main.o: ../Source/KabukiTheater/_/TESTS/main.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/f3c4c907
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f3c4c907/main.o ../Source/KabukiTheater/_/TESTS/main.cpp
