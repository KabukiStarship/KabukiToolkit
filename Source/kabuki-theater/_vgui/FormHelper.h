...
#include <nanogui/screen.hpp>
#include <nanogui/label.hpp>
#include <nanogui/checkbox.hpp>
#include <nanogui/textbox.hpp>
#include <nanogui/combobox.hpp>
#include <nanogui/colorpicker.hpp>
#include <nanogui/layout.hpp>
#include <cassert>
