/** Kabuki Theater
    @file    /.../Source/_Theater/HMI/Controller.hpp
...
/* This class _KabukiTheater_ represents a generic Control Surface.
   This class _KabukiTheater_ is to help facilitate the editing of templates on other control surfaces through the Symmetry Live!'s API.
...
*/
{
    ...
    double doublePressTime;     //< The max time period that constitutes a "double press", or "double click"
    /**
    MIDIDevice
    */
};
