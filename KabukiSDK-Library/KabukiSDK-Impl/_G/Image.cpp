...
/**  */
int GetWidth () { return imageRowWidthInBytes; }
...
/** Draws the source to the C on the NW corner. */
static void Image::Draw (Cell& C, Image source)
{
...
/** This method draws the source to the C. */
static void Image::Draw (Cell& C, Image source, int leftEdge, int topEdge)
{
...
static void Image::DrawClippedHorizontalLine (uint32_t canvasColorData, uint32_t sourceColorData, 
