/** Kabuki Theater
    @file    /.../Source/KabukiTheater-Impl/_Theater/MIDI/Message.cpp
...
#include <_Theater/MIDI/Message.hpp>
...
const Member* OutputHeaderQueue::op (_::Terminal* io, byte index)
{
    switch (index)
    {
        case '?': return deviceMember<"_Theater::MIDI::OutputHeaderQueue", 0, "A MIDI output queue.";
    }
