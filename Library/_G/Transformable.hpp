...
public:
    ...
    /// \code
    /// _G::Vector2f pos = object.getPosition();
    ...
    /// Thus, it is equivalent to the following code:
    /// \code
    /// _G::Vector2f scale = object.getScale();
...
////////////////////////////////////////////////////////////
/// \class _G::Transformable
/// \ingroup graphics
///
/// This class is provided for convenience, on top of _G::Transform.
///
/// _G::Transform, as a low-level class, offers a great level of
...
///
/// That's exactly what _G::Transformable was written for: it hides
...
/// transform (as a _G::Transform), and keeps it up-to-date.
///
/// In addition to the position, rotation and scale, _G::Transformable
...
/// bottom-right corner.
///
/// To keep the _G::Transformable class simple, there's only one
/// origin for all the components. You cannot position the sprite
/// relatively to its top-left corner while rotating it around its
/// center, for example. To do such things, use _G::Transform directly.
///
/// _G::Transformable can be used as a base class. It is often
/// combined with _G::Drawable -- that's what SFML's sprites,
/// texts and shapes do.
/// \code
/// class MyEntity : public _G::Transformable, public _G::Drawable
/// {
...
///     }
///
///     void Draw(_G::RenderTarget& target) const
///     {
///         target.draw(..., myTransform.getTransform());
///     }
///
/// private:
///     _G::Transformable myTransform;
/// };
/// \endcode
///
...
/// In order to render a _G::Drawable object pixel-perfectly, make sure
