...
#ifndef HEADER_FOR_KABUKI_TOOLKIT_HMI_MIDIBUTTON
#define HEADER_FOR_KABUKI_TOOLKIT_HMI_MIDIBUTTON
...
#endif  //< HEADER_FOR_KABUKI_TOOLKIT_HMI_MIDIBUTTON
