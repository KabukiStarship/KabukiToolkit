...
#ifndef DOXYGEN_SHOULD_SKIP_THIS
    template <typename T> friend struct serialization_helper;
#endif
public:
    /*
    ...
    GLShader()
        : mVertexShader(0), mFragmentShader(0), mGeometryShader(0),
          mProgramShader(0), mVertexArrayObject(0) = default;
     ...
     *    :member:`mBufferObjects <_::GLShader::mBufferObjects>`.
     *
     ...
     *    :func:`attribVersion <_::GLShader::attribVersion>`.  If you want
     *    to share data between :class:`GLShader <_::GLShader>` objects,
     *    call :func:`shareAttrib <_::GLShader::shareAttrib>`.
     *
     ...
     *    buffer's :member:`Buffer::id <_::GLShader::Buffer::id>` is the
 ...
 */
class SDK GLFramebuffer {
public:
    // Default constructor: unusable until you call the `init()` method
    GLFramebuffer() : mFramebuffer(0), mDepth(0), mColor(0) { }
 ...
 * mouse callbacks defined in @ref _::Widget.  The Arcball operates by
 ...
 *
 * A very simple @ref _::Screen derived class to illustrate usage:
 *
 * \rst
 * @code
 *
 *    class ArcballScreen : public _::Screen {
 *    public:
 *        // Creating a 400x400 window
 *        ArcballScreen() : _::Screen({400, 400}, "ArcballDemo") {
 ...
 *     :func:`Arcball::setSize <_::Arcball::setSize>`, this does **not**
 ...
 *     :func:`Widget::mouseButtonEvent <_::Widget::mouseButtonEvent>`
 *     and :func:`Widget::mouseMotionEvent <_::Widget::mouseMotionEvent>`
 ...
 *     `p` before calling :func:`Arcball::button <_::Arcball::button>`
 *     or :func:`Arcball::motion <_::Arcball::motion>`.  For example, if
...
struct Arcball {
     ...
     * .. note::
     *
     *    Make sure to call :func:`Arcball::setSize <_::Arcball::setSize>`
     *    after construction.
     * \endrst
     *
     * @param speedFactor
    ...
    Arcball(float speedFactor = 2.0f)
        :  mLastPos(Vector2i::Zero()), mSize(Vector2i::Zero()),
     ...
     * have a callback that created a @ref _::MessageDialog which will now
     * be in focus.
     */
 ...
 */
extern SDK Vector3f project(const Vector3f &obj,
 ...
 */
extern SDK Vector3f unproject(const Vector3f &win,
                                         const Matrix4f &model,
                                         const Matrix4f &proj,
                                         const Vector2i &viewportSize);
 ...
 * \endrst
 */
extern SDK Matrix4f lookAt(const Vector3f &origin,
 ...
 *     The far plane.
 */
extern SDK Matrix4f ortho(float left, float right,
 ...
 *     The far plane.
 */
extern SDK Matrix4f frustum(float left, float right,
                                       float bottom, float top,
                                       float nearVal, float farVal);
/*
 ...
 */
extern SDK Matrix4f scale(const Vector3f &v);
 ...
 */
extern SDK Matrix4f translate(const Vector3f &v);
