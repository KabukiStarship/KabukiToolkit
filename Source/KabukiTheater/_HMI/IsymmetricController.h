...
*/
{
    ...
    enum {
        MaxWidgets              = 0x7FFFFFFF,   //< The maximum amount of templates  (Should there be one?).
        MaxMixerChannels        = 1024,
        NumModes                = 5,            //< The number of modes per ParameterSet on the SL!
    ...
    */
    ...
    const _::Member* op (_::Terminal* io, byte index);
