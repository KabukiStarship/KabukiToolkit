/** Kabuki Toolkit
    @version 0.x
    @file    ~/source/script/expression.h
...
#ifndef HEADER_FOR___EXPRESSION
#define HEADER_FOR___EXPRESSION
...
/** Script Bell Operation rings the bell of the given address. */
KABUKI void ExpressionRingBell (Expression* expr, const char* address = "");

/** Script Ack-back Operation replies an ACK to a Bell Operation. */
