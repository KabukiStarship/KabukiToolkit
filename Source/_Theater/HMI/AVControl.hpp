/** Kabuki Theater
    @file    /.../Source/_Theater/HMI/AVControl.hpp
...
class _KabukiTheater_ AVControl: public Label, public _::IEvent
...
*/
{
    ...
    AVControl (int newType, const string &newLabel = "", int newChannel = 0, int initValue = 0, int newMinValue = 0,
