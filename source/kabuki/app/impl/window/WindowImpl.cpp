...
// Headers
////////////////////////////////////////////////////////////
#include <SFML/Window/WindowImpl.h>
#include <SFML/Window/Event.h>
#include <SFML/Window/JoystickManager.h>
#include <SFML/Window/SensorManager.h>
...
#include <cmath>
    ...
    #include <SFML/Window/Win32/WindowImplWin32.h>
    typedef sf::priv::WindowImplWin32 WindowImplType;

#elif defined(SFML_SYSTEM_LINUX) || defined(SFML_SYSTEM_FREEBSD)

    #include <SFML/Window/Unix/WindowImplX11.h>
    typedef sf::priv::WindowImplX11 WindowImplType;

#elif defined(SFML_SYSTEM_MACOS)

    #include <SFML/Window/OSX/WindowImplCocoa.h>
    typedef sf::priv::WindowImplCocoa WindowImplType;

#elif defined(SFML_SYSTEM_IOS)

    #include <SFML/Window/iOS/WindowImplUIKit.h>
    typedef sf::priv::WindowImplUIKit WindowImplType;

#elif defined(SFML_SYSTEM_ANDROID)

    #include <SFML/Window/Android/WindowImplAndroid.h>
