/** Kabuki Toolkit
    @file    ~/source/kabuki/mixer_page.h
...
#ifndef HEADER_FOR_KABUKI_HMI_MIXERPAGE
#define HEADER_FOR_KABUKI_HMI_MIXERPAGE
...
/** Class that represents a page of mixer channels on the Symmetry Live!
    ...
    mixer can either be sorted in ascending track index order or the page banks can be customized to make buses.
*/
class KABUKI MixerPage {
    ...
    std::vector<MixerChannel*> channels_; //< Array of pointers to pointers to MixerChannel(s).
    
};      //< class MixerPage
}       //< namespace Mixer
}       //< namespace kabuki
#endif  //< HEADER_FOR_KABUKI_HMI_MIXERPAGE
