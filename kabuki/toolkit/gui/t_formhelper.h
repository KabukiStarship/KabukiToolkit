...
*/
/*
 * @file /kabuki/toolkit/gui/formhelper.h
 *
...
#include "t_screen.h"
#include "t_label.h"
#include "t_checkbox.h"
#include "t_textbox.h"
#include "t_combobox.h"
#include "t_colorpicker.h"
#include "t_layout.h"
...
- Inheritance from :class:`_::ComboBox` for `enum` types:
...
- Inheritance from :class:`_::IntBox` for integral types:
...
- Inheritance from :class:`_::FloatBox` for floating point types:
...
- Inheritance from :class:`_::CheckBox` for booleans:
...
- Inheritance from :class:`_::TextBox` for strings:
...
- Inheritance from :class:`_::ColorPicker` for :class:`_::Color` types:
...
/* Convenience class to create simple AntTweakBar-style layouts that expose
...
public:
    ...
    template <typename Type> FormWidget<Type> *
...
protected:
    // A reference to the @ref _::Screen this FormHelper is assisting.
    ref<Screen> mScreen;

    // A reference to the @ref _::Window this FormHelper is controlling.
    ref<Window> mWindow;

    // A reference to the @ref _::AdvancedGridLayout this FormHelper is using.
...
public:
    ...
    // Pass-through function for @ref _::CheckBox::setChecked.
    void setValue(bool v) { setChecked(v); }

    // Pass-through function for @ref _::Widget::setEnabled.
    void setEditable(bool e) { setEnabled(e); }

    // Returns the value of @ref _::CheckBox::checked.
...
@tparam T The type being used inside the ComboBox. */
...
public:
    ...
    // Pass-through function for @ref _::ComboBox::selectedIndex.
    T value() const { return (T) selectedIndex(); }

    // Pass-through function for @ref _::ComboBox::setSelectedIndex.
    void setValue(T value) { setSelectedIndex((int) value); mSelectedIndex = (int) value; }

    // Pass-through function for @ref _::ComboBox::setCallback.
...
@tparam T The **integral** type being used for the IntBox. */
...
@tparam T The **floating point** type being used for the FloatBox. */
...
public:
    ...
    // Pass-through function for @ref _::TextBox::setCallback.
...
public:
    ...
    // Pass-through function for @ref _::ColorPicker::setColor.
    void setValue(const Color &c) { setColor(c); }

    // Pass-through function for @ref _::Widget::setEnabled.
    void setEditable(bool e) { setEnabled(e); }

    // Returns the value of @ref _::ColorPicker::color.
