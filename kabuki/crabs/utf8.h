/* Kabuki Toolkit
@version 0.x
@file    $kabuki-toolkit/kabuki/crabs/utf8.h
...
number.
@return A pointer to the next non-number in the text char. */
KABUKI const char* TextNumberEnd(const char* text);
...
KABUKI char* Print(char* begin, char* end, const char* string);
...
KABUKI char* Print(char* begin, char* end, char character);
...
KABUKI char* Print(char* begin, char* end, uint32_t value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* Print(char* begin, char* end, int32_t value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* Print(char* begin, char* end, uint64_t value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* Print(char* begin, char* end, int64_t value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* Print(char* begin, char* end, float value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* Print(char* begin, char* end, double value);
...
@param end    The end address of the buffer.
@param string The potentially unsafe string to write. */
KABUKI char* PrintCenter(char* begin, char* end, const char* string,
                         int column_count);
...
@param end The end address of the buffer.
@param character The value to write. */
KABUKI char* PrintCenter(char* begin, char* end, char character,
                         int column_count);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintCenter(char* begin, char* end, uint32_t valu,
                         int column_count);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintCenter(char* begin, char* end, int32_t value,
                         int column_count);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintCenter(char* begin, char* end, uint64_t value,
                         int column_count);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintCenter(char* begin, char* end, int64_t value,
                         int column_count);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintCenter(char* begin, char* end, float value, int column_count);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintCenter(char* begin, char* end, double value,
                         int column_count);
...
@param end    The end address of the buffer.
@param string The potentially unsafe string to write. */
KABUKI char* PrintRight(char* begin, char* end, const char* string,
                        int column_count);
...
@param end       The end address of the buffer.
@param character The value to write. */
KABUKI char* PrintRight(char* begin, char* end, char character,
                        int column_count);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintRight(char* begin, char* end, uint32_t value,
                        int column_count);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintRight(char* begin, char* end, int32_t value,
                        int column_count);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintRight(char* begin, char* end, uint64_t value,
                        int column_count);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintRight(char* begin, char* end, int64_t value,
                        int column_count);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintRight(char* begin, char* end, float value, int column_count);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintRight(char* begin, char* end, double value, int column_count);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintHex(char* begin, char* end, int8_t value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintHex(char* begin, char* end, uint16_t value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintHex(char* begin, char* end, int16_t value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintHex(char* begin, char* end, uint32_t value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintHex(char* begin, char* end, int32_t value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintHex(char* begin, char* end, uint64_t value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintHex(char* begin, char* end, int64_t value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintHex(char* begin, char* end, float value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintHex(char* begin, char* end, double value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintBinary(char* begin, char* end, uint8_t value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintBinary(char* begin, char* end, int8_t value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintBinary(char* begin, char* end, uint16_t value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintBinary(char* begin, char* end, int16_t value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintBinary(char* begin, char* end, uint32_t value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintBinary(char* begin, char* end, int32_t value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintBinary(char* begin, char* end, uint64_t value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintBinary(char* begin, char* end, int64_t value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintBinary(char* begin, char* end, float value);
...
@param end The end address of the buffer.
@param value The value to print. */
KABUKI char* PrintBinary(char* begin, char* end, double value);
...
KABUKI const char* TextScan(const char* text, int16_t& result);
...
@return Returns a pointer to the next char after the end
of the read number or nil upon failure. */
KABUKI const char* TextScan(const char* text, uint16_t& result);
...
@return Returns a pointer to the next char after the end
of the read number or nil upon failure. */
KABUKI const char* TextScan(const char* text, int32_t& result);
...
@return Returns a pointer to the next char after the end
of the read number or nil upon failure. */
KABUKI const char* TextScan(const char* text, uint32_t& result);
...
@return Returns a pointer to the next char after the end
of the read number or nil upon failure. */
KABUKI const char* TextScan(const char* text, int64_t& result);
...
@return Returns a pointer to the next char after the end
of the read number or nil upon failure. */
KABUKI const char* TextScan(const char* text, uint64_t& result);
...
@return Returns a pointer to the next char after the end
of the read number or nil upon failure. */
KABUKI const char* TextScan(const char* text, float& result);
