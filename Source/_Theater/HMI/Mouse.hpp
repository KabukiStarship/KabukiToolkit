...
class _KabukiTheater_ Mouse
/*< Give access to the real-time state of the mouse. 
    @ingroup _Theater/HMI
   
    _Theater/HMI::Mouse provides an interface to the state of the
    ...
    and MouseButtonReleased events, _Theater/HMI::Mouse can retrieve the
    ...
    Usage example:
    @code
    if (_Theater/HMI::Mouse::isButtonPressed(_Theater/HMI::Mouse::Left))
    {
        // left click...
    }
   
    // get global mouse position
    _Theater/HMI::Vector2i position = _Theater/HMI::Mouse::getPosition();
   
    // set mouse position relative to a window
    _Theater/HMI::Mouse::setPosition(_Theater/HMI::Vector2i(100, 200), window);
    @endcode
   
    @see _Theater/HMI::Joystick, _Theater/HMI::Keyboard, _Theater/HMI::Touch */
{
    public:
