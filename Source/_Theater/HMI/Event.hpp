...
#include <_Theater/HMI/Mouse.hpp>
#include <_Theater/HMI/Sensor.hpp>
...
/*< Defines a system event and its parameters. 
    ...
    _Theater/HMI::Event holds all the informations about a system event
    that just happened. Events are retrieved using the
    _Theater/HMI::Window::pollEvent and _Theater/HMI::Window::waitEvent functions.
   
    A _Theater/HMI::Event instance contains the type of the event
    ...
    Usage example:
    @code
    _Theater/HMI::Event event;
    while (window.pollEvent(event))
    {
        // Request for closing the window
        if (event.type == _Theater/HMI::Event::Closed)
            window.close();
   
        // The escape key was pressed
        if ((event.type == _Theater/HMI::Event::KeyPressed) && (event.key.code == _Theater/HMI::Keyboard::Escape))
            window.close();
   
        // The window was resized
        if (event.type == _Theater/HMI::Event::Resized)
