...
/** Give access to the real-time state of the keyboard. 
    ...
    hmi::Keyboard provides an interface to the state of the
    ...
    hmi::Keyboard can retrieve the state of a key at any time
    ...
    Usage example:
    @code
    if (hmi::Keyboard::isKeyPressed(hmi::Keyboard::Left)) {
        // move left...
    } else if (hmi::Keyboard::isKeyPressed(hmi::Keyboard::Right)) {
        // move right...
    } else if (hmi::Keyboard::isKeyPressed(hmi::Keyboard::Escape)) {
        // quit...
    }
    @endcode
   
    @see hmi::Joystick, hmi::Mouse, hmi::Touch */
