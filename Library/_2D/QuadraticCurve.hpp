...
* @since 1.2
*/
public static class QuadraticCurve_f: public QuadraticCurve
{
    /**
    ...
    */
    ...
    /**
    * Constructs and initializes a <code>QuadraticCurve</code> with
    ...
    */
    ...
    static final long serialVersionUID = -8511188402130719609L;
};

/**
 * The <code>QuadraticCurve</code> class defines a quadratic parametric curve
...
class QuadraticCurve
{
     ...
     * @since 1.2
     */
    public static class QuadraticCurve_d extends QuadraticCurve implements Serializable {
        /**
         * The X coordinate of the start point of the quadratic curve
         * segment.
         * @since 1.2
     ...
     * methods below.
     *
     * @see java.awt.geom.QuadraticCurve.Float
     * @see java.awt.geom.QuadraticCurve.Double
     * @since 1.2
     */
     ...
     * <code>QuadraticCurve</code> to the <code>double</code> coordinates at
     ...
     * <code>QuadraticCurve</code> to the specified <code>Point2D</code>
     * coordinates.
    ...
    /**
     * Sets the location of the end points and control points of this
     * <code>QuadraticCurve</code> to the coordinates of the
    ...
    /**
     * Sets the location of the end points and control point of this
     * <code>QuadraticCurve</code> to the same as those in the specified
     * <code>QuadraticCurve</code>.
     * @param c the specified <code>QuadraticCurve</code>
     * @since 1.2
     */
    public void setCurve(QuadraticCurve c) {
     ...
     * control point from the line connecting the end points, of this
     * <code>QuadraticCurve</code>.
     * @return the flatness of this <code>QuadraticCurve</code>.
     * @since 1.2
     */
    ...
    /**
     * Subdivides this <code>QuadraticCurve</code> and stores the resulting
     * two subdivided curves into the <code>left</code> and
     * <code>right</code> curve parameters.
     * Either or both of the <code>left</code> and <code>right</code>
     * objects can be the same as this <code>QuadraticCurve</code> or
     * <code>null</code>.
     * @param left the <code>QuadraticCurve</code> object for storing the
     * left or first half of the subdivided curve
     * @param right the <code>QuadraticCurve</code> object for storing the
     * right or second half of the subdivided curve
     * @since 1.2
     */
    public void subdivide(QuadraticCurve left, QuadraticCurve right) {
     ...
     * @since 1.2
     */
    public static void subdivide(QuadraticCurve src,
                                 QuadraticCurve left,
                                 QuadraticCurve right) {
        double x1 = src.getX1();
        double y1 = src.getY1();
     ...
     * shape of this <code>QuadraticCurve</code>.
     * The iterator for this class is not multi-threaded safe,
     * which means that this <code>QuadraticCurve</code> class does not
     * guarantee that modifications to the geometry of this
     * <code>QuadraticCurve</code> object do not affect any iterations of
    ...
    /**
     * Returns an iteration object that defines the boundary of the
     * flattened shape of this <code>QuadraticCurve</code>.
     * The iterator for this class is not multi-threaded safe,
     * which means that this <code>QuadraticCurve</code> class does not
     * guarantee that modifications to the geometry of this
     * <code>QuadraticCurve</code> object do not affect any iterations of
