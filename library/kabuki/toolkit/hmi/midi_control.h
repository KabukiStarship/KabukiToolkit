/** Kabuki Toolkit
    @file    ~/source/hmi/control_midi.h
...
#ifndef HEADER_FOR_KABUKI_TOOLKIT_HMI_MIDICONTROL
#define HEADER_FOR_KABUKI_TOOLKIT_HMI_MIDICONTROL
...
#endif  //< HEADER_FOR_KABUKI_TOOLKIT_HMI_MIDICONTROL
