...
@file    /kabuki/features/hmi/hmi_isymmetric_controller.cc
...
IsymmetricController::IsymmetricController()
  ...
  for (int i = 0; i < MaxTemplates; ++i) templatesArray[i] = nullptr;
}
...
int IsymmetricController::GetNumDevices() { return numDevices; }
...
int IsymmetricController::GetCommonChannel() { return commonChannel; }

int IsymmetricController::GetKeyboardChannel() { return keyboardChannel; }
...
int IsymmetricController::GetDrumsChannel() { return drumsChannel; }
...
int IsymmetricController::GetTicksPerBeat() { return numTicksPerBeat; }
