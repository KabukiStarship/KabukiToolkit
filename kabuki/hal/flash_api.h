 ...
 *
 * The address should be at sector boundary. This function does not do any check
 * for address alignments
 * @param obj The flash object
 ...
 *
 * This function has a WEAK implementation using memcpy for backwards
 * compatibility.
 * @param obj The flash object
 ...
 * @return 0 for success, -1 for error
 */
int32_t flash_read(flash_t *obj, uint32_t address, uint8_t *data,
                   uint32_t size);

/** Program pages starting at defined address
 *
 * The pages should not cross multiple sectors.
 * This function does not do any check for address alignments or if size is
 * aligned to a page size.
 * @param obj The flash object
 * @param address The sector starting address
