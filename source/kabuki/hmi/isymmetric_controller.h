/** Kabuki Toolkit
    @file    ~/source/kabuki/hmi//IsymmetricController.h
...
#ifndef HEADER_FOR_KABUKI_HMI_ISYMMETRICCONTROLLER
#define HEADER_FOR_KABUKI_HMI_ISYMMETRICCONTROLLER
...
class IsymmetricController: public Controller {
    ...
    */
    ...
    const _::Operation* Op (uint index, _::Expression* expr);
    ...
    std::vector<Widget*> modes,    //< 5 different modes on the Symmetry Live!
    ...
    //std::vector<MIDIDevice> devices; //< array of all of the MIDI devices currently attached to this system.
    //int numMIDIInDev,            //< Number of MIDI input devices attached to the system.
    //     numMIDIOutDev;          //< Number of MIDI output devices attached to the system.
...
#endif  //< HEADER_FOR_KABUKI_HMI_ISYMMETRICCONTROLLER
