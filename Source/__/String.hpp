    ...
    interface for Unicode handling, see the _::UTF classes. */
{
    ...
    friend _ChineseRoom_ bool operator == (const String& left, const String& right);
    friend _ChineseRoom_ bool operator < (const String& left, const String& right);

    std::basic_string<uint32_t> m_string; //< Internal string of UTF-32 characters
};

_ChineseRoom_ bool operator == (const String& left, const String& right);
...
_ChineseRoom_ String operator + (const String& left, const String& right);
/*< @relates String
