...
void PrintHex(int16_t value) { return PrintHex<uint16_t, int16_t>(value); }

void PrintHex(uint32_t value) { return PrintHex<uint32_t>(value); }

void PrintHex(int32_t value) { return PrintHex<uint32_t, int32_t>(value); }

void PrintHex(uint64_t value) { return PrintHex<uint64_t>(value); }

void PrintHex(int64_t value) { return PrintHex<uint64_t, int64_t>(value); }
