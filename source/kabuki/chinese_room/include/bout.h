/** The Chinese Room
    @version 0.x
    @file    ~/source/kabuki/chinese_room/include/bout.h
...
#ifndef CHINESE_ROOM_BOUT_H
#define CHINESE_ROOM_BOUT_H
...
/** Gets a a string for printing out the bout_state. */
...
/** Operation + prints a string to the bout. */
inline Bout& operator+ (Bout& bout, const char * s);

}       //< namespace _
#endif  //< CHINESE_ROOM_BOUT_H
