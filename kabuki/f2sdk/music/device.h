...
/** Class that represents a MIDI device connected to the computer.
    This class API extends a MIDI device class API that is platform specific. Each OS has different
    ...
    external MIDI only devices. This class API supports them too. A MIDI device might be spread out over
    several different internal MIDI connections. Each Internal MIDI device have one global instance
    of a class API associated with it. This class API will store pointers to the static instances of the ports
