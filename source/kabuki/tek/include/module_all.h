/** kabuki::tek
    @file    ~/source/kabuki/tek/include/module_all.h
...
#ifndef KABUKI_TEK_MODULE_ALL_H
#define KABUKI_TEK_MODULE_ALL_H
...
class BouncySwitch: public _::Operation
{
    public:
