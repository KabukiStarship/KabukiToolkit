...
@file    /kabuki/features/touch/c_keyevent.h
...
#ifndef KABUKI_TEK_KEYEVENT
#define KABUKI_TEK_KEYEVENT 1
...
class CKeyEvent {
 public:
  ...
  /* Constructs a EventKey from the given VK keyboard code. */
  CKeyEvent (SI4 vk_code)
    : vk_code_ (vk_code);

  /* Gets the VK code of the event. */
  SI4 Code () { return vk_code_; }

 private:

  SI4 vk_code_;  //< VK keyboard code of the event.
};

}  // namespace _
#endif  //< KABUKI_TEK_KEYEVENT
