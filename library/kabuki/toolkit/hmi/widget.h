...
#ifndef HEADER_FOR_KABUKI_TOOLKIT_HMI_WIDGET
#define HEADER_FOR_KABUKI_TOOLKIT_HMI_WIDGET
...
class KABUKI Widget : public _::Op {
    ...
    data::Array<ControlMatrix*> controls_; //< Control grids.
...
#endif  //< HEADER_FOR_KABUKI_TOOLKIT_HMI_WIDGET
