/** Kabuki Toolkit
    @file    ~/source/kabuki/hmi/key_event_buffer.h
...
#ifndef HEADER_FOR_KABUKI_HMI_KEYEVENTBUFFER
#define HEADER_FOR_KABUKI_HMI_KEYEVENTBUFFER
...
#endif  //< HEADER_FOR_KABUKI_HMI_KEYEVENTBUFFER
