...
@file    /touch/t_isymmetricController.h
...
#ifndef kabuki.toolkit_AV_ISYMMETRICCONTROLLER
#define kabuki.toolkit_AV_ISYMMETRICCONTROLLER
...
#endif  //< kabuki.toolkit_AV_ISYMMETRICCONTROLLER
