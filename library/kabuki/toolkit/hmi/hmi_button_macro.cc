/** Kabuki Toolkit
    @file    ~/source/hmi/macro_button.cc
...
int ButtonMacro::GetNumControls () const {
    return num_controls_;
}

void ButtonMacro::ClearControls () {
    ClearList (controls_);
}
...
int ButtonMacro::maxWordValue () const {
...
void ButtonMacro::toggle () {
    Button::toggle ();
}

string ButtonMacro::label () const {
...
Parameter<int>* ButtonMacro::removeAfter (LinearNode<Parameter<int>*>* thisNode) {
    if (thisNode == nullptr)
        return nullptr;
