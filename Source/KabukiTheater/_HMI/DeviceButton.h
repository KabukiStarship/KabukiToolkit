/** Kabuki Theater
    @file    /.../Source/_HMI/Buttons/DeviceButton.hpp
...
class _HMI_Devices_ MacroButton;
class _HMI_Devices_ MacroEvent;
class _HMI_Devices_ Device;
class _HMI_Devices_ ControlsPage;
...
class _HMI_Devices_ DeviceButton : public MacroButton
{
    public:
