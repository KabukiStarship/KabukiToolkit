...
#ifndef KABUKI_BLACKJACK_H
#define KABUKI_BLACKJACK_H


#ifndef KABUKI_CARDS__BLACKJACK__BLACKJACKDEALER_H_INCLUDED
#define DOJOCARDGAME__BLACKJACKS__BLACKJACKDEALER_H_INCLUDED
...
public:
    ...
    static const int numDecks = 1,                          //< The number of decks for this game.
...
#endif // KABUKI_CARDS__BLACKJACK__BLACKJACK__DEALER_H_INCLUDED