/** Kabuki Theater
    @file    /.../Source/KabukiTheater-Impl/_HMI/TESTS/OSCControlTests.hpp
...
/** Unit test for the OSCControl class _KabukiTheater_. */
{
    public:
    ...
    void runTest () 
    {
        ...
        logMessage ("Done testing OSCControl class _KabukiTheater_");
    }
