...
#ifndef HEADER_FOR_KABUKI_TOOLKIT_HMI_PAGEBUTTON
#define HEADER_FOR_KABUKI_TOOLKIT_HMI_PAGEBUTTON
...
#endif  //< HEADER_FOR_KABUKI_TOOLKIT_HMI_PAGEBUTTON
