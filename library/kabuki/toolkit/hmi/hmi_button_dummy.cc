/** Kabuki Toolkit
    @file    ~/source/hmi/dummy_button.cc
...
ButtonDummy::ButtonDummy (const char* initLabel) : 
    Button (initLabel)
{
    // Nothing to do here!
}
...
void ButtonDummy::Press (ButtonEvent buttonEvent)
{
    Press ();
}

void ButtonDummy::Depress (ButtonEvent buttonEvent)
{
    Depress ();
}
...
const Op* ButtonDummy::Op (wchar_t index, _::Verifier* io) {
    static const Op kThis = {
        "ButtonDummy", NumMembers (0), "kabuki::hmi::Button"
    };
