/** Kabuki Toolkit
    @file    ~/source/hmi/event_button.h
...
#ifndef HEADER_FOR_KABUKI_TOOLKIT_HMI_EVENTBUTTON
#define HEADER_FOR_KABUKI_TOOLKIT_HMI_EVENTBUTTON
...
#endif  //< HEADER_FOR_KABUKI_TOOLKIT_HMI_EVENTBUTTON
