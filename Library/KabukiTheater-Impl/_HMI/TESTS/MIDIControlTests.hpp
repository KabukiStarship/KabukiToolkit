/** Kabuki Theater
    @file    /.../KabukiTheater-Library/KabukiTheater-Impl/_HMI/TESTS/Module.hpp
...
#if DEBUG
/** Unit test for the DMXControl class _KabukiTheater */
class _KabukiTheater MIDIControlTests : public UnitTest
{
    public:
    ...
    void runTest ()
    {
        ...
        LogMessage ("Done testing Controls::MIDIControl class _KabukiTheater. :-)\n");
    }
};
