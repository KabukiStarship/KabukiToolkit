...
class _KabukiTheater_ Sensor
/*< Give access to the real-time state of the sensors
    @ingroup _Theater/HMI
   
    _Theater/HMI::Sensor provides an interface to the state of the
    ...
    its events. Compared to the SensorChanged event, _Theater/HMI::Sensor
    ...
    _Theater/HMI::Sensor::isAvailable function.
    ...
    all disabled by default. You must call _Theater/HMI::Sensor::setEnabled for each
    sensor in which you are interested.
   
    Usage example:
    @code
    if (_Theater/HMI::Sensor::isAvailable(_Theater/HMI::Sensor::Gravity))
    {
        // gravity sensor is available
    }
   
    // enable the gravity sensor
    _Theater/HMI::Sensor::setEnabled(_Theater/HMI::Sensor::Gravity, true);
   
    // get the current value of gravity
    _Theater/HMI::Vector3f gravity = _Theater/HMI::Sensor::getValue(_Theater/HMI::Sensor::Gravity);
    @endcode
*/
{
    public:
