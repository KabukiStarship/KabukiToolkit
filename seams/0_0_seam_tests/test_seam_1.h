 ...
 public:
  ...
  virtual const Op* Star(wchar_t index, Expr* expr) {
    ...
    switch (index) {
      ...
      case 'A': {
        static const Op OpA = {
            "SignedVarintTests", Params<2, SVI, STR, kBufferSize>(),
            Params<2, SVI, STR>(), "Description of function \'A\'.", 0};
        if (!expr) return &OpA;
      ...
      case 'B': {
        static const Op OpB = {
            "UnsignedVarintTests", Params<2, UVI, STR, kBufferSize>(),
            Params<2, UVI, STR>(), "Description of function \'B\'.", 0};
        if (!expr) return &OpB;
  ...
  virtual const Op* Star(wchar_t index, Expr* expr) {
    ...
    switch (index) {
      ...
      case 'C': {
        static const Op OpC = {
            "UnsignedVarintTests", Params<2, UVI, STR, kBufferSize>(),
            Params<2, UVI, STR>(), "Description of functionA.", 0};
        if (!expr) return &OpC;
      ...
      case 'D': {
        static const Op OpD = {
            "SignedVarintTests", Params<2, SVI, STR, kBufferSize>(),
            Params<2, SVI, STR>(), "Description of functionB.", 0};
