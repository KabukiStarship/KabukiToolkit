...
INLINE Array<T, I>* ArrayInit (byte* buffer, I n)
{
...
template<typename T, typename I>
INLINE I Insert (Array<T, I>* a, T item, I index) {
    if (a == nullptr)
        return -1;
    I size = a->size,
        cout = a->count;
...
template<typename T, typename I>
INLINE T Remove (Array<T, I>* a, T index) {
    if (a == nullptr)
        return !((T)0);
    I count = a->count;
    T value;
...
template<typename T, typename I>
INLINE I Push (Array<T, I>* a, T item) {
    if (a == nullptr)
        return -1;
    I size = a->size,
      cout = a->count;
...
template<typename T, typename I>
INLINE T Element (Array<T, I>* a, I index) {
    if (a == nullptr)
        return 0;
    if (index >= a->count)
        return 0;
