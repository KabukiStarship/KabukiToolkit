...
#ifndef HEADER_FOR_SCRIPT_EXPRESSION
#define HEADER_FOR_SCRIPT_EXPRESSION
...
KABUKI const Op* ExprSetState (Expr* expr,
                                            BIn::State state);

/** Saves the current bin_state and sets the bin_state to the new state. */
KABUKI const Op* ExprEnterState (Expr* expr, 
                                              BIn::State state);
...
KABUKI const Op* ExprScanHeader (Expr* expr,
                                              const uint_t* header);
