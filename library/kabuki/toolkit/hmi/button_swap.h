...
#ifndef HEADER_FOR_KABUKI_TOOLKIT_HMI_BUTTONSWAP
#define HEADER_FOR_KABUKI_TOOLKIT_HMI_BUTTONSWAP
...
class KABUKI ButtonSwap : public Button {
    ...
    data::Array<Button*> control_modes_; //< Array of control mode buttons.
};

}       //< hmi
}       //< namespace toolkit
}       //< namespace kabuki
#endif  //< HEADER_FOR_KABUKI_TOOLKIT_HMI_BUTTONSWAP
