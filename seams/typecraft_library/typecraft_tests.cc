...
@file    ~/typecraft/typecraft_tester.cc
...
TEST_GROUP(TYPECRAFT_TESTS){
    void setup(){std::cout << "\n|  + Running TypeCraft tests...\n";
}

void teardown() { std::cout << "| TypeCraft completed.\n"; }
}
;

TEST(TYPECRAFT_TESTS, TypeCraftTests) {}
