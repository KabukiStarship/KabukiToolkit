...
#include "KabukiSDK.h"
#include "_Archive/7Zip/7Zip.h"
#include "_Archive/7Zip/ArchiveEntry.h"
#include "_/BasicEvent.h"
#include <vector>
#include <utility>
...
/** This class represents a 7-Zip archive. 
    The Archive class can be used to enumerate entries in a 7-Zip archive, 
    and to extract files or directories from an archive. 
*/
class _KTkLib Archive
{
    public:

    typedef std::vector<ArchiveEntry> EntryVec;
    typedef EntryVec::iterator Iterator;
    typedef EntryVec::constIterator ConstIterator;
