...
class _KabukiTheater_ Joystick
/*< Give access to the real-time state of the joysticks.

    @ingroup _Theater/HMI
   
    _Theater/HMI::Joystick provides an interface to the state of the
    ...
    and JoystickButtonReleased events, _Theater/HMI::Joystick can retrieve the
    ...
    SFML supports:
    @li 8 joysticks (_Theater/HMI::Joystick::Count)
    @li 32 buttons per joystick (_Theater/HMI::Joystick::ButtonCount)
    @li 8 axes per joystick (_Theater/HMI::Joystick::AxisCount)
    ...
    you must call _Theater/HMI::Joystick::update explicitly.
   
    Usage example:
    @code
    // Is joystick #0 connected?
    bool connected = _Theater/HMI::Joystick::isConnected(0);
   
    // How many buttons does joystick #0 support?
    uint buttons = _Theater/HMI::Joystick::getButtonCount(0);
   
    // Does joystick #0 define a X axis?
    bool hasX = _Theater/HMI::Joystick::hasAxis(0, _Theater/HMI::Joystick::X);
   
    // Is button #2 pressed on joystick #0?
    bool pressed = _Theater/HMI::Joystick::isButtonPressed(0, 2);
   
    // What's the current position of the Y axis on joystick #0?
    float position = _Theater/HMI::Joystick::getAxisPosition(0, _Theater/HMI::Joystick::Y);
    @endcode
   
    @see _Theater/HMI::Keyboard, _Theater/HMI::Mouse */
{
    public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    struct _KabukiTheater_ Identification
    {
        Identification();
