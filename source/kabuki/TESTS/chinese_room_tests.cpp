...
TEST (ChineseRoomTests, RoomTests) {
...
TEST (ChineseRoomTests, ReadWriteTests) {
    ...
    CHECK_EQUAL (0, Write (tx, EmptyString, Esc<4, SI1, SI1, UI1, BOL> (),
    ...
    CHECK_EQUAL (0, Read (tx, Esc<4, SI2, SI2, UI2, HLF> (),
    ...
    CHECK_EQUAL (0, Write (tx, EmptyString, Esc<5, SI4, SI4, UI4, FLT, TMS> (),
                           Args (args, &si4_p_expected, &si4_n_expected,
                                 &ui4_expected, &flt_expected, &tms_expected)))
    CHECK_EQUAL (0, Read (tx, Esc<5, SI4, SI4, UI4, FLT, TMS> (),
    ...
    CHECK_EQUAL (0, Read (tx, Esc<5, TMU, SI8, SI8, UI8, DBL> (),
    ...
    int16_t sv2_found[7];
    CHECK_EQUAL (0, Write (tx, EmptyString, Esc<7, SV2, SV2, SV2, SV2, SV2, SV2, SV2> (),
                           Args (args, &sv2_expected[0], &sv2_expected[1],
                                 &sv2_expected[2], &sv2_expected[3],
                                 &sv2_expected[4], &sv2_expected[5],
                                 &sv2_expected[6])))
    CHECK_EQUAL (0, Read (tx, Esc<7, SV2, SV2, SV2, SV2, SV2, SV2, SV2>(),
    ...
    CHECK_EQUAL (0, Write (tx, EmptyString, Esc<4, UV2, UV2, UV2, UV2> (),
    ...
    CHECK_EQUAL (0, Write (tx, EmptyString, Esc<11, SV4, SV4, SV4, SV4, SV4, SV4, SV4, SV4,
                                   SV4, SV4, SV4> (),
                           Args (args, &sv4_expected[0], &sv4_expected[1],
                                 ...
                                 &sv4_expected[10])))
    CHECK_EQUAL (0, Read (tx, Esc<11, SV4, SV4, SV4, SV4, SV4, SV4, SV4, SV4, 
                                  SV4, SV4, SV4>(),
    ...
    CHECK_EQUAL (0, Write (tx, EmptyString, Esc<6, UV4, UV4, UV4, UV4, UV4, UV4> (),
                           Args (args, &uv4_expected[0], &uv4_expected[1],
                                 &uv4_expected[2], &uv4_expected[3],
                                 &uv4_expected[4], &uv4_expected[5])))
    CHECK_EQUAL (0, Read (tx, Esc<6, UV4, UV4, UV4, UV4, UV4, UV4> (),
    ...
    CHECK_EQUAL (0, Write (tx, EmptyString, Esc<19, SV8, SV8, SV8, SV8, SV8, SV8, SV8, SV8,
    ...
    CHECK_EQUAL (0, Write (tx, EmptyString, Esc<10, UV8, UV8, UV8, UV8, UV8, UV8, UV8, UV8,
                                   UV8, UV8> (),
    ...
    byte ar1_found[6];
    CHECK_EQUAL (0, Write (tx, EmptyString, Esc<1, AR1, 6, UI1> (), Args (args, &ar1_expected)))
    ...
    CHECK_EQUAL (0, Write (tx, EmptyString, Esc<1, AR2, 6, UI2> (), Args (args, &ar2_expected)))
    ...
    CHECK_EQUAL (0, Write (tx, EmptyString, Esc<1, AR4, 6, UI4> (), Args (args, &ar4_expected)))
    ...
    CHECK_EQUAL (0, Write (tx, EmptyString, Esc<1, AR8, 6, UI8> (), Args (args, &ar8_expected)))
