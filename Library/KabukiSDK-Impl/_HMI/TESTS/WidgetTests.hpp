/** Kabuki Software Development Kit
    @file    /.../KabukiSDK-Library/KabukiSDK-Impl/_HMI/TESTS/WidgetTests.hpp
...
class WidgetUnitTest : public UnitTest
{
    ...
    void runTest ()
    {
        beginTest ("Testing Controls::Widget class _KabukiSDK\n" + ConsoleLine ('~'));
        ...
        LogMessage ("Done testing Widget class _KabukiSDK");
    }
};