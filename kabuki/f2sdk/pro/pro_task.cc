...
const char* Task::GetHeader() { return summary_; }
...
const char* Task::GetDetails() { return details_; }
...
const char* Task::GetResults() { return result_; }
...
const char* Task::GetReview() { return review_; }
...
float Task::GetWeight() { return weight_; }
...
float Task::GetAssessment() { return assessment_; }
...
float Task::GetGrade() { return grade_; }
  ...
  if (c == '-') {
    ...
    switch (c) {
      ...
      case 'd':  // Details
        ...
        if (end == nullptr) return "Invalid details char";
        SetDetails(buffer);
        if (*end == 0) {
          std::cout << "\n> Task done\n";
          return nullptr;
      ...
      case 's':  // Header
        ...
        if (end == nullptr) return "Invalid summary char";
        SteadHeader(buffer);
        if (*end == 0) {
          std::cout << "\n> Task done\n";
          return nullptr;
      ...
      case 'v':  // Review
        ...
        if (end == nullptr) return "Invalid review char";
        StealReview(buffer);
