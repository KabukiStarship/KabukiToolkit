/* Kabuki Toolkit
@version 0.x
@file    $kabuki-toolkit/kabuki/crabs/str1.h
...
KABUKI const char* TextNumberStop(const char* text, const char* text_end);

/* Returns the pointer to the next char in the char that is not an ASCII
number.
@return A pointer to the next non-number in the text char. */
KABUKI const char* TextNumberStop(const char* text);
...
KABUKI const char* Scan(const char* begin, int8_t& result);
