/** Kabuki Software Development Kit
    @file    /.../KabukiSDK/_Math/Entity.hpp
...
class Entity
{
    ...
    Entity (SoftwareEngine theEngine, _Math::Point_f initPosition, string fileName);
    /*<  */
    
    Entity (SoftwareEngine theEngine, _Math::Point_f initPosition, string EntityName, _Math::Point* vertexList, 
        Polygon* polygonList);
    /*<  */
    ...
    void setPosition (_Math::Point_f newPoint);
    /*<  */
    ...
    void removeBackFacesAndShade (_Math::Point_f viewpoint, _Math::Point_f lightSource);
    /*<  */
