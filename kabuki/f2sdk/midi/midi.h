/** Kabuki Toolkit
    @file    ~/library/kabuki/toolkit/midi/midi.h
*/
...
/*
    Note: This section is here for reference only. These structs in in the Win.h header.
...
typedef struct MIDIEvent
{
    ...
    uint32_t dwParms[];    //< Event parameters.
                        /**< If dwEvent specifies MEVT_F_LONG and the length of the buffer, this member contains
                             ...
                             bytes uint32_t, three pad bytes must follow the data for a total of eight bytes. In this
