...
#elif MUL == 2                              //< No dynamic memory with 16-bit offsets.
typedef int16_t int_t;                      //< Buffer signed index type.
typedef uint16_t uint_t;                    //< Buffer unsigned signed index type.
typedef uint8_t TBookIndex;                 //< Book2 TIndex.
typedef uint16_t TBookHeader;               //< Book2 TBookHeader
typedef uint16_t TBookDataOffset;           //< Book2 TBookDataOffset
typedef hash16_t TBookHash;                 //< Book2 TBookHash

#elif MUL == 3                              //< Dynamic memory with 16-bit offsets.
typedef byte int_t;                         //< Buffer signed index type.
typedef int16_t uint_t;                     //< Buffer unsigned signed index type.
typedef byte TBookIndex;                    //< Book 4 TBookIndex
typedef uint16_t TBookHeader;               //< Book 4 TBookHeader
typedef uint16_t TBookDataOffset;           //< Book 4 TBookDataOffset
typedef hash16_t TBookHash;                 //< Book 4 TBookHash
...
#elif MUL == 5                              //< Dynamic memory with 32-bit offsets.
typedef int32_t int_t;                      //< Buffer signed index type.
typedef uint32_t uint_t;                    //< Buffer unsigned signed index type.
typedef uint16_t TBookIndex;                //< Book4 TIndex.
typedef uint16_t TBookHeader;               //< Book 4 TBookHeader
