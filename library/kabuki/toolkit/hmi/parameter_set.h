/** Kabuki Toolkit
    @file    ~/source/hmi/parameter_set.h
...
#ifndef HEADER_FOR_KABUKI_TOOLKIT_HMI_PARAMETERSET
#define HEADER_FOR_KABUKI_TOOLKIT_HMI_PARAMETERSET
...
class KABUKI ParameterSet {
    ...
    ParameterSet (const data::Array<Parameter<T>*>& controls);
    ...
    data::Array<Parameter<T>> params;   //< An array of Parameter<T> pointers.
};      //< class ParameterSet
}       //< namespace hmi
}       //< namespace toolkit
}       //< namespace kabuki
#endif  //< HEADER_FOR_KABUKI_TOOLKIT_HMI_PARAMETERSET
