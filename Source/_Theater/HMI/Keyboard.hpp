...
class _KabukiTheater_ Keyboard
/*< Give access to the real-time state of the keyboard. 
    @ingroup _Theater/HMI
   
    _Theater/HMI::Keyboard provides an interface to the state of the
    ...
    _Theater/HMI::Keyboard can retrieve the state of a key at any time
    ...
    Usage example:
    @code
    if (_Theater/HMI::Keyboard::isKeyPressed(_Theater/HMI::Keyboard::Left))
    {
        // move left...
    }
    else if (_Theater/HMI::Keyboard::isKeyPressed(_Theater/HMI::Keyboard::Right))
    {
        // move right...
    }
    else if (_Theater/HMI::Keyboard::isKeyPressed(_Theater/HMI::Keyboard::Escape))
    {
        // quit...
    }
    @endcode
   
    @see _Theater/HMI::Joystick, _Theater/HMI::Mouse, _Theater/HMI::Touch */
{
    public:
