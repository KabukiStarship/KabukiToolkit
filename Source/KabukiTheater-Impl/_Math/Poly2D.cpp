...
Poly2D_f::Poly2D_f (float* initXPoints, float* initYPoints, int initNumPoints, int initBufferSize)
...
float* Poly2D_f::getXPoints ()
{
    return x;
}

float* Poly2D_f::getYPoints ()
{
    return y;
}

int Poly2D_f::getNumPoints ()
{
    return numPoints;
}

int Poly2D_f::getBufferSize ()
{
    return bufferSize;
}

void Poly2D_f::translate (float dx, float dy)
{
...
void Poly2D_f::translate (int dx, int dy)
{
...
void Poly2D_f::calculateBounds (float* x, float* y, int numPoints)
{
...
void Poly2D_f::updateBounds (int x, int y)
{
    if (x < bounds.x)
    {
...
void Poly2D_f::addPoint (int newX, int newY)
{
...
const Rect_f& Poly2D_f::getBounds ()
{
    return bounds;
}
...
bool Poly2D_f::contains (Point<float> p)
{
...
bool Poly2D_f::contains (float x, float y)
{
...
bool Poly2D_f::intersects (float x, float y, float w, float h)
{
...
bool Poly2D_f::intersects (_Math::Rect_f r)
{
    return intersects (r.x, r.y, r.getWidth (), r.getHeight ());
}

bool Poly2D_f::contains (float x, float y, float w, float h)
{
...
bool Poly2D_f::contains (_Math::Rect_f r)
{
    return contains (r.x, r.y, r.getWidth (), r.getHeight ());
}

PathIterator_f Poly2D_f::getPathIterator (AffineTransform_f a)
{
    return new Poly2DPathIterator_f (this, a);
}

PathIterator_f Poly2D_f::getPathIterator (AffineTransform_f a, float flatness)
{
    return getPathIterator (a);
}

/*
Crossings_f Poly2D_f::getCrossings (float xlo, float ylo, float xhi, float yhi)
{
...
Poly2DPathIterator_f::Poly2DPathIterator_f (Poly2D_f p, AffineTransform_f a)
:   polygon   (p),
    transform (a)
{
