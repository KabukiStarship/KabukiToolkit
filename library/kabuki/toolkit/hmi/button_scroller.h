/** Kabuki Toolkit
    @file    ~/source/hmi//button_scroller.h
...
#ifndef HEADER_FOR_KABUKI_TOOLKIT_HMIBUTTONSCROLLER
#define HEADER_FOR_KABUKI_TOOLKIT_HMIBUTTONSCROLLER
...
class KABUKI ButtonScroller: public HmiComponent {
    ...
    data::Array<IButton*> buttons_; //< Array of buttons.
};

}       //< namespace hmi
}       //< namespace toolkit
}       //< namespace kabuki
#endif  //< HEADER_FOR_KABUKI_TOOLKIT_HMIBUTTONSCROLLER
