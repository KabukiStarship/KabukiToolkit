/** kabuki::cards
    @file   ~/kabuki::cards Library/Card.cs
...
namespace DojoCardGames
{
    ...
    */
    ...
    {
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        // I like to use 120 character lines ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~>
        ...
        public const int NumSuits = 4,  //< The number of suits.
            ...
            /// Misc
            Default = -1;               //<  Flag to create the default values for a card.
        ...
        */
        ...
        /** Getter and setter for the face value of this Card.
            The face value is a number between 0-10 in blackjack. In other card games though,  this can be any 
            number so we aren't going to do any error checking before setting the faceValue.*/
        ...
        public static Card RandomCard ()
        {
            ...
            return new Card (randomGenerator.Next (Card.NumPips), randomGenerator.Next (Card.NumSuits));
        }
