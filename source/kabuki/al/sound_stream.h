...
/** Abstract base class for streamed audio sources.
    ...
    @endcode
    @see sf::Music */
class AUDIO_API SoundStream : public SoundSource
{
    public:
    ...
    /** Set whether or not the stream should loop after reaching the
        end.
...
private:
    ...
    /** Fill a new buffer with audio samples, and append
