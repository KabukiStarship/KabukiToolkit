...
const char* Project::GetKey() { return key_; }
...
void Project::SetKey(const char* new_name) { StealKey(TextClone(new_name)); }

const char* Project::GetReadMe() { return readme_; }
...
const char* Project::Command(char* input, Stack<Project*>* stack) {
