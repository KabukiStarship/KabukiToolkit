/** Kabuki Toolkit
    @file    ~/source/hmi/control_matrix.h
...
#ifndef HEADER_FOR_KABUKI_TOOLKIT_HMI_CONTROLMATRIX
#define HEADER_FOR_KABUKI_TOOLKIT_HMI_CONTROLMATRIX
...
#endif  //< HEADER_FOR_KABUKI_TOOLKIT_HMI_CONTROLMATRIX
