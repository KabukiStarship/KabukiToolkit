/** Kabuki Theater
    @file    /.../Source/KabukiTheater-Impl/_Theater/MIDI/ShortMessage.cpp
...
#include <_Theater/MIDI/Port.h>
#include <_Theater/MIDI/Message.h>
...
const char* Port::op (_::Terminal* io, byte index)
{
    ...
    return Query ? Enquery ("Port", "_Com::MIDI"): InvalidIndex ();
}
