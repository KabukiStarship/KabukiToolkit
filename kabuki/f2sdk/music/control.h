...
In the future, we need to implement the other tYpes of advanced controls like
SysEx and Program changes.
*/
class API Control {
 public:
  /** Default constructor. */
  Control(int16_t initCC = 0, int16_t initValue = 0, int16_t initMinValue = 0,
          int16_t initMaxValue = 127, int16_t initLSB = 0,
