/** Kabuki Theater
    @file    /.../KabukiTheater-Impl/_Com/MIDI/OutputPort.cpp
...
#include <_Com/MIDI/OutputPort.h>
...
/*
bool OutputPort::getCapabilities  (uint32_t deviceID, MIDIOUTCAPS &portCapabilties)
{
...
const char* OutputPort::Do (const char* Query, byte Index, Roombot* Bot)
{
    switch (Index)
    {
    ...
    return Query ? Enquery ("OutputPort", "_Com::MIDI"): InvalidIndex ();
}
