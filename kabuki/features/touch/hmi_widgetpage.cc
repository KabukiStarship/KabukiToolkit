...
@file    /kabuki/features/hmi/hmi_widget_page.cc
...
int WidgetPage::GetNumControlPairs() { return numControlPairs; }
...
const char* WidgetPage::GetLabel() { return pageLabel; }
void WidgetPage::SetLabel(const char* name) { pageLabel = name; }
...
bool WidgetPage::MasterControlsEnabled() { return mstr_controls_enabled_; }
